...
function toggleDarkMode() {
    ...
    darkMode = !darkMode;
    if (darkMode) {
        (_a = document.getElementById('html')) === null || _a === void 0 ? void 0 : _a.classList.add('dark');
        ...
        (_b = document.getElementById('html')) === null || _b === void 0 ? void 0 : _b.classList.remove('dark');
