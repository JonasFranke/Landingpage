      ...
      <>
          ...
          <main className="overflow-hidden">
              ...
              <div className="flex justify-center">
                  <p className="text-gray-700 font-mono hover:text-gray-600 transition-colors duration-300">Hover over a logo</p>
              </div>
              <div className={`transition-all duration-500 delay-200 ${fadeOut ? "opacity-0" : "opacity-100"}`}>
                  <p className="flex justify-center text-white">{hoveredLogo ? hoveredLogo : ""}</p>
                  <div className="flex justify-center">{hoveredLogo == 'Github' ?
