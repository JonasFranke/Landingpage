...
const GithubDetailsComponent: React.FC<GithubDetailsComponent> = ({onMouseEnter, onMouseLeave}) => {
    return (
        <div onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} className="border-2 border-green-700 p-3">
            ...
            <div className="flex justify-center">
                {/* SVG from https://www.svgrepo.com/svg/452234/java
                    ...
                    MIT License
                */}
                <svg className="size-1/12 p-1" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <title>Java</title>
                    <path
                ...
                {/* SVG from https://www.svgrepo.com/svg/349540/typescript
                    ...
                    MIT License
                */}
                <svg className="size-1/12 p-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
